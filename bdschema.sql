...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Gestionnaire (
	...
	courriel	VARCHAR(60),
	PRIMARY KEY (IDEmploye),
	FOREIGN KEY (IDEmploye) REFERENCES TOURNOIS_SPORTSDB.Employe(IDEmploye) ON UPDATE CASCADE --herite Employe
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Ligue (
	...
	PRIMARY KEY (IDLigue),
	FOREIGN KEY (IDSport) REFERENCES TOURNOIS_SPORTSDB.Sport(IDSport) ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.GestionnaireLigue (
	...
	FOREIGN KEY (IDEmploye) REFERENCES TOURNOIS_SPORTSDB.Gestionnaire(IDEmploye) ON UPDATE CASCADE,
	FOREIGN KEY (IDLigue) REFERENCES TOURNOIS_SPORTSDB.Ligue(IDLigue) ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.ArbitreLigue (
	...
	IDLigue	VARCHAR(20) NOT NULL,
	PRIMARY KEY (IDEmploye,IDLigue),
	FOREIGN KEY (IDEmploye) REFERENCES TOURNOIS_SPORTSDB.Arbitre(IDEmploye) ON UPDATE CASCADE,
	FOREIGN KEY (IDLigue) REFERENCES TOURNOIS_SPORTSDB.Ligue(IDLigue) ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.UsagerSport (
	...
	FOREIGN KEY (IDUsager) REFERENCES TOURNOIS_SPORTSDB.Usager(IDUsager) ON UPDATE CASCADE,
	FOREIGN KEY (IDSport) REFERENCES TOURNOIS_SPORTSDB.Sport(IDSport) ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Gerant (
	...
	PRIMARY KEY (IDUsager),
	FOREIGN KEY (IDUsager) REFERENCES TOURNOIS_SPORTSDB.Usager(IDUsager) ON UPDATE CASCADE --herite usager
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Equipe (
	...
	FOREIGN KEY (IDUsager) REFERENCES TOURNOIS_SPORTSDB.Gerant(IDUsager) ON UPDATE CASCADE, --relation gerant-equipe
	FOREIGN KEY (IDLigue) REFERENCES TOURNOIS_SPORTSDB.Ligue(IDLigue) ON UPDATE CASCADE --relation equipe-ligue
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.UsagerEquipe (
	...
	FOREIGN KEY (IDUsager) REFERENCES TOURNOIS_SPORTSDB.Usager(IDUsager) ON UPDATE CASCADE,
	FOREIGN KEY (IDEquipe) REFERENCES TOURNOIS_SPORTSDB.Equipe(IDEquipe) ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.EquipeSaison (
	...
	FOREIGN KEY (IDEquipe) REFERENCES TOURNOIS_SPORTSDB.Equipe(IDEquipe) ON UPDATE CASCADE,
	FOREIGN KEY (IDSaison) REFERENCES TOURNOIS_SPORTSDB.Saison(IDSaison) ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Tournoi (
	...
	fondsAccumules		VARCHAR(60) NOT NULL, --A REVOIR
	dateDebut		DATE NOT NULL,
	dateFin			DATE NOT NULL,
	IDSport			VARCHAR(20) NOT NULL,
	PRIMARY KEY (IDTournoi),
	FOREIGN KEY (IDSport) REFERENCES TOURNOIS_SPORTSDB.Sport(IDSport) ON UPDATE CASCADE --relation tournoi-sport
);

--ARRAY OF 2 INTs FOR THE SCORE? COMMENT IMPLEMENTER LE SCORE ENTREE PAR L'ARBITRE?
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Match (
	...
	PRIMARY KEY (IDMatch),
	FOREIGN KEY (IDSaison) REFERENCES TOURNOIS_SPORTSDB.Saison(IDSaison) ON UPDATE CASCADE, --relation match-saison
	FOREIGN KEY (IDTournoi) REFERENCES TOURNOIS_SPORTSDB.Tournoi(IDTournoi) ON UPDATE CASCADE --relation match-tournoi
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.ArbitreMatch (
	...
	FOREIGN KEY (IDEmploye) REFERENCES TOURNOIS_SPORTSDB.Arbitre(IDEmploye) ON UPDATE CASCADE,
	FOREIGN KEY (IDMatch) REFERENCES TOURNOIS_SPORTSDB.Match(IDMatch) ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Paiement (
	...
	FOREIGN KEY (IDUsager) REFERENCES TOURNOIS_SPORTSDB.Gerant(IDUsager) ON UPDATE CASCADE,
	FOREIGN KEY (IDEquipe) REFERENCES TOURNOIS_SPORTSDB.Equipe(IDEquipe) ON UPDATE CASCADE,
	FOREIGN KEY (IDSaison) REFERENCES TOURNOIS_SPORTSDB.Saison(IDSaison) ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Commanditaire (
	IDCommanditaire		VARCHAR(20) NOT NULL,
	prenom			VARCHAR(60) NOT NULL,
	nom			VARCHAR(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.CommanditaireTournoi (
	...
	FOREIGN KEY (IDCommanditaire) REFERENCES TOURNOIS_SPORTSDB.Commanditaire(IDCommanditaire) ON UPDATE CASCADE,
	FOREIGN KEY (IDTournoi) REFERENCES TOURNOIS_SPORTSDB.Tournoi(IDTournoi) ON UPDATE CASCADE
);
