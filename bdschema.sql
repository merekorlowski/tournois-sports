...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Equipe (
	...
	FOREIGN KEY (IDLigue) REFERENCES TOURNOIS_SPORTSDB.Ligue(IDLigue) ON DELETE CASCADE ON UPDATE CASCADE--relation equipe-ligue
);
...
CREATE TABLE IF NOT EXISTS TOURNOIS_SPORTSDB.Saison (
	...
	FOREIGN KEY (IDLigue) REFERENCES TOURNOIS_SPORTSDB.Ligue(IDLigue) ON DELETE CASCADE ON UPDATE CASCADE
);
