...
define('services/equipes',['exports', 'aurelia-fetch-client', '../models/equipe', '../models/usager'], function (exports, _aureliaFetchClient, _equipe, _usager) {
  ...
  var ServiceEquipes = exports.ServiceEquipes = function () {
    ...
    ServiceEquipes.prototype.getGerant = function getGerant(idequipe) {
      return this.http.fetch('equipe/gerant?idequipe=' + idequipe).then(function (response) {
        return response.json();
      }).then(function (data) {
    ...
    ServiceEquipes.prototype.post = function post(idusager, idequipe) {
  ...
  var ServiceLigues = exports.ServiceLigues = function () {
    ...
    ServiceLigues.prototype.deleteEquipe = function deleteEquipe(idequipe) {
      return this.http.fetch('ligue/equipe', {
        method: 'delete',
        body: (0, _aureliaFetchClient.json)(idequipe)
      });
    };
...
define('services/tournois',['exports', 'aurelia-fetch-client', '../models/tournoi', '../models/commanditaire', '../models/saison', '../models/match', '../models/equipe'], function (exports, _aureliaFetchClient, _tournoi, _commanditaire, _saison, _match, _equipe) {
  ...
  var ServiceTournois = exports.ServiceTournois = function () {
    ...
    ServiceTournois.prototype.getPoints = function getPoints(idmatch, idequipe) {
      return this.http.fetch('match/equipe/points?idmatch=' + idmatch + '&idequipe=' + idequipe).then(function (response) {
        return response.json();
      }).then(function (data) {
        return data[0].nbrpoints;
	...
	var EquipeView = exports.EquipeView = (_dec = (0, _aureliaFramework.inject)(_equipes.ServiceEquipes), _dec(_class = function () {
		...
		EquipeView.prototype.getEquipe = function getEquipe(idequipe) {
			...
			this.serviceEquipes.getEquipe(idequipe).then(function (equipe) {
				...
				_this.serviceEquipes.getGerant(idequipe).then(function (gerant) {
					_this.gerant = gerant;
				});
		...
		EquipeView.prototype.ajouter = function ajouter() {
			...
			this.serviceEquipes.post(this.nouveauJoueur.idusager, this.equipe.idequipe).then(function () {
				_this3.ajoutAffiche = false;
...
define('views/ligue/index',['exports', 'aurelia-framework', '../../services/ligues', '../../models/equipe'], function (exports, _aureliaFramework, _ligues, _equipe) {
	'use strict';
	...
	var LigueView = exports.LigueView = (_dec = (0, _aureliaFramework.inject)(_ligues.ServiceLigues), _dec(_class = function () {
		...
		LigueView.prototype.ajouterEquipe = function ajouterEquipe() {
			...
			this.serviceLigues.postEquipe(this.nouveauEquipe).then(function (equipe) {
				_this4.ajoutEquipeAffiche = false;
				_this4.equipes.push(_this4.nouveauEquipe);
				_this4.nouveauEquipe = new _equipe.Equipe();
				_this4.nouveauEquipe.idligue = _this4.ligue.idligue;
				_this4.nouveauEquipe.statutdeforfait = false;
...
define('views/saison/index',['exports', 'aurelia-framework', '../../services/saisons', '../../services/matchs', '../../services/ligues', '../../models/match', '../../models/equipe'], function (exports, _aureliaFramework, _saisons, _matchs, _ligues, _match, _equipe) {
	...
	var SaisonView = exports.SaisonView = (_dec = (0, _aureliaFramework.inject)(_saisons.ServiceSaisons, _matchs.ServiceMatchs, _ligues.ServiceLigues), _dec(_class = function () {
		...
		SaisonView.prototype.activate = function activate(params, navigation) {
			...
			this.equipeA = new _equipe.Equipe();
			this.equipeB = new _equipe.Equipe();
		};
		...
		SaisonView.prototype.ajouter = function ajouter() {
			...
			this.serviceSaisons.postMatch(this.nouveauMatch, this.equipeA, this.equipeB).then(function () {
				...
				_this4.equipeA = new _equipe.Equipe();
				_this4.equipeB = new _equipe.Equipe();
					...
					var _loop = function _loop() {
						...
						_this.serviceTournois.getEquipes(match.idmatch).then(function (equipes) {
							...
							var _loop2 = function _loop2() {
								...
								_this.serviceTournois.getPoints(match.idmatch, equipe.idequipe).then(function (points) {
