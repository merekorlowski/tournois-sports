	...
	var LigueView = exports.LigueView = (_dec = (0, _aureliaFramework.inject)(_ligues.ServiceLigues, _usagers.ServiceUsagers), _dec(_class = function () {
		...
		LigueView.prototype.ajouterEquipe = function ajouterEquipe() {
			...
			this.serviceLigues.postEquipe(this.nouveauEquipe).then(function (equipe) {
				...
				_this5.nouveauEquipe.statutdeforfait = false;
...
define('views/tournoi/sports/index',['exports'], function (exports) {
  'use strict';
...
define('text!views/tournoi/sports/styles.css', ['module'], function(module) { module.exports = ""; });
define('text!views/tournoi/sports/index.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"./styles.css\"></require>\n  <section>\n    <router-view></router-view>\n  </section>\n</template>\n"; });
